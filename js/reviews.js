  ...
  function (e, t, n) {
    ...
    e.exports =
      ...
      n(14)(function () {
        ...
        ? function (e, t) {
            for (
              var n = a(e), c = arguments.length, l = 1, p = i.f, u = r.f;
              c > l;
      ...
      c = function (e, t, n) {
        ...
        (l.initialize = function () {
          ...
          (l.requireWidget = function (e) {
            "string" != typeof e &&
              l.logError("Widget Public ID required and should be a string", {
                pid: e,
              }),
          ...
          (l.resetWidget = function (e) {
            ...
            l.getWidgetsElements().forEach(function (n) {
              l.getWidgetIdByElement(n) === e &&
                (delete p[e], n.parentNode.replaceChild(t(e), n));
            });
          }),
            ...
            if (o.length) {
              ...
              r.open("get", a + "?" + s),
                ...
                (r.onload = function () {
                  ...
                  e.status ||
                    l.logError("Boot failed because " + e.reason, e.data),
          ...
          ? (e.split("&").forEach(function (e) {
            ...
            Object.keys(i)
              ...
              .reduce(function (e, t) {
                var n = i[t];
                return (
                  Boolean(n) && "object" === o(n) && !Array.isArray(n)
                    ? (e[t] = s(n))
                    : (e[t] = n),
                  e
                );
        ...
        (e.initialize = function () {
          ...
          (e.__sendTestViewEvent = function (e) {
            if (window.fetch) {
              ...
              fetch("https://__events.elfsight.com/events/views", {
                method: "POST",
            ...
            if (n) {
              ...
              if (t.lifetime) {
                var r = "eapps-" + t.widgetId + "-" + t.event + "-expiration",
                  ...
                  c = s < a;
                !s || c
                  ? window.localStorage.setItem(r, a + t.lifetime)
                  : (i = !1);
              }
              i &&
                e.buffer.push({
